...
const ENDPOINT = process.env.PROXY_BACKEND_URL;
const URL = `${ENDPOINT}/api-idm-sidesa.php`;
...
async function fetchData() {
  ...
  try {
    ...
    console.log("Received response from GET request.");
    ...
    console.log("Finished writing data to JSON files.");
  ...
  console.log("Finished fetchData function.");
}
