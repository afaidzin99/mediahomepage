...
export const metadata: Metadata = {
  title: "Sangga Baruna - Media Informasi Seputar Desa Pesanggaran",
  description:
    "Media Informasi Seputar Desa Pesanggaran. Dikelola oleh tim KKN PPN UGM Sangga Baruna Pesanggaran.",
};
